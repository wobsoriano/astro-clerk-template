...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "./astro/assets-service_BbOh4xJi.mjs"
    ).then((n) => n._).catch((e) => {
...
}, "/Users/wobsoriano/Documents/tmp/astro-clerk-template/node_modules/astro/components/Image.astro", void 0);
...
}, "/Users/wobsoriano/Documents/tmp/astro-clerk-template/node_modules/astro/components/Picture.astro", void 0);
